...
export const iconCode = base(
  `<Toggle variant="outline" aria-label="Toggle appearance"><Sun /></Toggle>`,
);
export const textCode = base(
  `<div className="flex gap-1"><Toggle aria-label="Bold"><Bold /></Toggle><Toggle aria-label="Italic"><Italic /></Toggle></div>`,
);
