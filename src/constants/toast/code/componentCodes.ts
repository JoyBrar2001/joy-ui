...
export const toastWithActionCode = simpleToastCode
  .replace("Changes saved", "Item archived")
  .replace(
    "Your profile has been updated successfully.",
    "The item was moved to your archive.",
  );
export const toastWithLongMessageCode = simpleToastCode
  .replace("Changes saved", "Upload complete")
  .replace(
    "Your profile has been updated successfully.",
    "Your files are now available to the rest of your team.",
  );
