...
export const sliderData: ComponentCategory = {
  ...
  steps: [
    {
      type: "dependencies",
      libraries: ["clsx", "tailwind-merge", "@radix-ui/react-slider"],
    },
    {
      type: "utilities",
      files: [
  ...
  components: [
    ...
    {
      title: "Slider with Ruler Markings",
      component: RulerSlider,
      code: rulerSliderCode,
    },
    {
      title: "Slider with Percentage",
      component: PercentageSlider,
      code: percentageSliderCode,
    },
  ],
};
