  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        chevron:
          "size-6 cursor-pointer rounded-sm border border-neutral-300 fill-neutral-900 p-1 transition hover:bg-neutral-100 dark:border-neutral-800 dark:fill-white dark:hover:bg-neutral-800",
        months: "flex flex-col md:flex-row",
        month:
          "px-4 not-last:border-b not-last:border-b-neutral-800 md:not-last:border-b-0 md:not-last:border-r md:not-last:border-r-neutral-800",
        month_caption: "flex justify-center items-center py-3",
        weekdays: "grid grid-cols-7 w-full my-2",
        weekday:
          "inline-flex flex justify-center items-center text-sm font-light",
        ...
        day_button:
          "flex size-10 items-center justify-center disabled:text-neutral-400 disabled:hover:bg-white dark:disabled:text-neutral-700 dark:disabled:hover:bg-black",
        ...
        selected:
          props.mode === "range"
            ? ""
            : "rounded-md bg-neutral-900 text-white hover:bg-neutral-900 dark:bg-white dark:text-neutral-900 dark:hover:bg-white",
        range_start:
          "rounded-l-md rounded-r-none bg-neutral-900 text-white hover:bg-neutral-900 dark:bg-white dark:text-neutral-900 dark:hover:bg-white",
        range_end:
          "rounded-r-md rounded-l-none bg-neutral-900 text-white hover:bg-neutral-900 dark:bg-white dark:text-neutral-900 dark:hover:bg-white",
        range_middle:
          "rounded-none bg-neutral-200 text-neutral-900 dark:bg-neutral-800 dark:text-white",
        ...classNames,
      }}
      showOutsideDays={
