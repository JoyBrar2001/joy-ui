...
import {
  progress25Code,
  progress65Code,
  progressCompleteCode,
  progressCustomHeightCode,
...
export const progressData: ComponentCategory = {
  ...
  steps: [
    {
      type: "dependencies",
      libraries: ["clsx", "tailwind-merge", "@radix-ui/react-progress"],
    },
    {
      type: "utilities",
      files: [
  ...
  components: [
    ...
    { title: "Progress at 65%", component: ProgressAt65, code: progress65Code },
    {
      ...
      code: progressCompleteCode,
    },
    {
      title: "Progress with Custom Height",
      component: ProgressCustomHeight,
      code: progressCustomHeightCode,
    },
  ],
};
