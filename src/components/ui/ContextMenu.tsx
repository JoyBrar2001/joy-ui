...
export const ContextMenuSubTrigger = Primitive.SubTrigger;
...
export function ContextMenuItem({ className, ...props }: Primitive.ContextMenuItemProps) { return <Primitive.Item className={cn("flex cursor-default select-none items-center rounded px-3 py-2 text-sm outline-none focus:bg-neutral-100 dark:focus:bg-neutral-800", className)} {...props} />; }
