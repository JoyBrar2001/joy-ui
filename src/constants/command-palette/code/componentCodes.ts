...
export const groupedCommandPaletteCode = simpleCommandPaletteCode
  .replace("Search documentation", "Go to dashboard")
  .replace("Open settings", "View documents");
export const commandPaletteWithShortcutsCode = simpleCommandPaletteCode.replace(
  "Open palette",
  "Keyboard shortcuts",
);
