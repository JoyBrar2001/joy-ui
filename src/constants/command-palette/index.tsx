...
import {
  commandPaletteWithShortcutsCode,
  groupedCommandPaletteCode,
  simpleCommandPaletteCode,
...
export const commandPaletteData: ComponentCategory = {
  ...
  steps: [
    { type: "dependencies", libraries: ["clsx", "tailwind-merge", "cmdk"] },
    {
      type: "utilities",
      files: [
        {
  ...
  components: [
    {
      ...
      component: SimpleCommandPalette,
      code: simpleCommandPaletteCode,
    },
    {
      title: "Grouped Command Palette",
      component: GroupedCommandPalette,
      code: groupedCommandPaletteCode,
    },
    {
      title: "Command Palette with Shortcuts",
      component: CommandPaletteWithShortcuts,
      code: commandPaletteWithShortcutsCode,
    },
  ],
};
