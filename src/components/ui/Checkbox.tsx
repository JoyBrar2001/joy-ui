    ...
    >
      <CheckboxPrimitive.CheckboxIndicator
        className={cn(
          ...
          animate &&
            "data-[state=checked]:animate-scaleUp data-[state=unchecked]:animate-scaleDown",
        )}
      >
...
export function CheckboxLabel({
  ...
  return (
    <label
      className={cn(
        "flex items-center gap-1 text-sm leading-none text-neutral-900 dark:text-white",
        className,
      )}
      htmlFor={htmlFor}
      {...props}
...
export function CheckboxSubLabel({
  children,
  className,
  ...props
...
export function CheckboxDescription({
  ...
  return (
    <p
      className={cn("text-xs leading-none text-neutral-600", className)}
      {...props}
    >
      {children}
    </p>
