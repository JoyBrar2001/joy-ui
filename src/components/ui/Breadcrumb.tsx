...
export const BreadcrumbEntry = forwardRef<
  HTMLLIElement,
...
>(({ className, children, ...props }, ref) => (
  <a
    ref={ref}
    className={cn(
      "transition-colors hover:text-neutral-950 dark:hover:text-white",
      className,
    )}
    {...props}
  >
...
export const BreadcrumbCurrent = forwardRef<
  HTMLSpanElement,
...
>(({ className, children, ...props }, ref) => (
  <span
    ref={ref}
    aria-current="page"
    className={cn("font-medium text-neutral-950 dark:text-white", className)}
    {...props}
  >
    {children}
  </span>
...
>(({ className, children, ...props }, ref) => (
  <li
    ...
    role="presentation"
    aria-hidden="true"
    className={cn("inline-flex items-center text-neutral-400", className)}
    {...props}
  >
