  ...
  return (
    <Accordion type="single" collapsible>
      <AccordionItem value="ui-components">
        ...
        <AccordionContent>
          Our library offers well-designed, accessible, and customizable UI
      ...
      <AccordionItem value="performance">
        ...
        <AccordionContent>
          The components are lightweight and optimized for speed, ensuring a
      ...
      <AccordionItem value="customization">
        ...
        <AccordionContent>
          You can easily modify colors, styles, and animations to fit your
          brand’s identity.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
