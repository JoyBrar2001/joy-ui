export const draggableDrawerCode = `"use client";
...
export const drawerWithBackdropCode = `"use client";
...
export const drawerWithBackdropBlurCode = `"use client";
...
export function DrawerWithBackdropBlur() {
  const [isOpen, setOpen] = useState(false);
  const ref = useRef<SheetRef>(null);
...
export const simpleDrawerCode = `"use client";
...
export const snappableDrawerCode = `"use client";
