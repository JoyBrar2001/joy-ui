...
import {
  menuPopoverCode,
  profileCardPopoverCode,
  simpleBottomPopoverCode,
  simpleLeftPopoverCode,
  simpleRightPopoverCode,
  simpleTopPopoverCode,
...
export const popoverData: ComponentCategory = {
  ...
  steps: [
    {
      type: "dependencies",
      libraries: ["clsx", "tailwind-merge", "@radix-ui/react-popover"],
    },
    {
      type: "utilities",
      files: [
