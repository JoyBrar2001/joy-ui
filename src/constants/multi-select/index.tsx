...
import {
  controlledMultiSelectCode,
  disabledMultiSelectCode,
  multiSelectWithDefaultsCode,
  searchableMultiSelectCode,
  ...
  components: [
    {
      ...
      code: simpleMultiSelectCode,
    },
    {
      title: "Multi-select with Defaults",
      component: MultiSelectWithDefaults,
      code: multiSelectWithDefaultsCode,
    },
    {
    ...
    {
      title: "Disabled Multi-select Option",
      component: DisabledMultiSelect,
      code: disabledMultiSelectCode,
    },
    {
      title: "Controlled Multi-select",
      component: ControlledMultiSelect,
      code: controlledMultiSelectCode,
    },
  ],
};
