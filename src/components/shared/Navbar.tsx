  ...
  return (
    <header
      className={cn(
        ...
        scrolled &&
          "top-2 w-[calc(100%-1rem)] scale-95 md:top-5 md:w-[90%] lg:w-[85%] mx-auto border border-neutral-200 dark:border-neutral-700 rounded-[2.5rem] backdrop-blur-xl",
      )}
    >
          ...
          <ul className="flex gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 md:text-base">
            ...
            <li>
              <Link href="/components/creative">
                <CreativeButton>Creative</CreativeButton>
              </Link>
            </li>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          type="button"
          className="flex size-10 items-center justify-center rounded-md text-black hover:bg-neutral-100 dark:text-white dark:hover:bg-neutral-800 md:hidden"
        ...
        <Link href="https://github.com/JoyBrar2001/joy-ui" target="_blank">
      ...
      {mobileOpen && (
        <nav className="absolute left-2 right-2 top-[calc(100%+0.5rem)] rounded-2xl border border-neutral-200 bg-white/95 p-2 shadow-xl backdrop-blur-xl dark:border-neutral-800 dark:bg-neutral-950/95 md:hidden">
          <Link
            href="/components/ui"
            onClick={() => setMobileOpen(false)}
            className="block rounded-lg px-4 py-3 text-sm font-medium text-neutral-700 hover:bg-neutral-100 dark:text-neutral-200 dark:hover:bg-neutral-800"
          >
            UI Components
          </Link>
          <Link
