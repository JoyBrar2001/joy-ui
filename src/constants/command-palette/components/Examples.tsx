      ...
      <CommandPalette open={open} onOpenChange={setOpen}>
        <CommandPaletteGroup heading="Actions">
          <CommandPaletteItem onSelect={() => setOpen(false)}>
            ...
            Create event{" "}
            <kbd className="ml-auto text-xs text-neutral-500">⌘E</kbd>
          </CommandPaletteItem>
          <CommandPaletteItem onSelect={() => setOpen(false)}>
            <Search className="size-4" />
            Search <kbd className="ml-auto text-xs text-neutral-500">⌘K</kbd>
          </CommandPaletteItem>
        </CommandPaletteGroup>
        <CommandPaletteSeparator />
        <CommandPaletteItem onSelect={() => setOpen(false)}>
          Close palette{" "}
          <kbd className="ml-auto text-xs text-neutral-500">Esc</kbd>
        </CommandPaletteItem>
      </CommandPalette>
    </>
  );
