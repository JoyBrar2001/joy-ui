          ...
          <Card className="flex items-center space-x-2">
            <CardContent className="flex gap-2">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-xs text-neutral-500">
                  Uses a mix of performance and battery saving for longer
                  sessions that require performance
                </p>
              </div>
            </CardContent>
          </Card>
          <Card className="flex items-center space-x-2">
            <CardContent className="flex gap-2">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-xs text-neutral-500">
                  Maximizes the performance by extracting everything for your
                  CPU, significantly reducing battery tho
                </p>
              </div>
            </CardContent>
          </Card>
