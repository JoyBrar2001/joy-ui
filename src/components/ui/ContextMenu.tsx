...
export function ContextMenuContent({
  className,
  ...props
}: Primitive.ContextMenuContentProps) {
  return (
    <Primitive.Portal>
      <Primitive.Content
        className={cn(
...
export function ContextMenuItem({
  className,
  ...props
}: Primitive.ContextMenuItemProps) {
  return (
    <Primitive.Item
      className={cn(
        "flex cursor-default select-none items-center gap-3 rounded px-3 py-2 text-sm outline-none focus:bg-neutral-100 dark:focus:bg-neutral-800",
        className,
      )}
      {...props}
    />
...
export function ContextMenuCheckboxItem({
  className,
  ...props
}: Primitive.ContextMenuCheckboxItemProps) {
  return (
...
export function ContextMenuSeparator({
  className,
  ...props
}: Primitive.ContextMenuSeparatorProps) {
  return (
    <Primitive.Separator
      className={cn(
...
export function ContextMenuSubTrigger({
  ...
  children,
  ...props
}: Primitive.ContextMenuSubTriggerProps) {
  return (
...
export function ContextMenuSubContent({
  className,
  ...props
}: Primitive.ContextMenuSubContentProps) {
  return (
    <Primitive.SubContent
      className={cn(
        "z-50 min-w-40 overflow-hidden rounded-lg border border-neutral-200 bg-white p-1 text-neutral-900 shadow-xl dark:border-neutral-700 dark:bg-neutral-900 dark:text-white",
        className,
      )}
      {...props}
    />
