...
import {
  selectDisabledCode,
  selectStatusCode,
  selectWithAvatarCode,
  selectWithCustomIconCode,
  selectWithDefaultValueCode,
  selectWithDisabledOptionsCode,
  selectWithGroupsCode,
  selectWithIconsCode,
  selectWithScrollCode,
  selectWithScrollIconsCode,
  selectWithSearchCode,
  selectWithSeparatorCode,
  simpleSelectAnimatedCode,
  simpleSelectCode,
...
export const selectData: ComponentCategory = {
  ...
  steps: [
    {
      type: "dependencies",
      libraries: ["clsx", "tailwind-merge", "@radix-ui/react-select"],
    },
    {
      type: "utilities",
      files: [
